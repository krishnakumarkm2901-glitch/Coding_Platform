...
export const Modal = ({ isOpen, onClose, title, children, maxWidth = 'max-w-2xl' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      ...
      {/* Modal Dialog */}
      <div className={`relative w-full ${maxWidth} rounded-2xl sm:rounded-3xl border border-[#D9E0E8] dark:border-[#30363D] bg-[#FFFFFF] dark:bg-[#20252C] text-[#172033] dark:text-[#F8FAFC] shadow-2xl z-10 overflow-hidden transform transition-all my-4 sm:my-8 max-h-[90vh] flex flex-col`}>
        {/* Header */}
